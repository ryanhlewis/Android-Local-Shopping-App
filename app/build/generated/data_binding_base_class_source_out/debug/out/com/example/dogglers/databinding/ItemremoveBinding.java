...
public final class ItemremoveBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button trash;

  private ItemremoveBinding(@NonNull MaterialCardView rootView, @NonNull TextView dogAge,
      @NonNull TextView dogAge2, @NonNull TextView dogHobby, @NonNull TextView dogName,
      @NonNull ImageView dogPicture, @NonNull Button trash) {
  ...
  @NonNull
  public static ItemremoveBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemremoveBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.itemremove, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemremoveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.trash;
      Button trash = rootView.findViewById(id);
      if (trash == null) {
        break missingId;
      }

      return new ItemremoveBinding((MaterialCardView) rootView, dogAge, dogAge2, dogHobby, dogName,
          dogPicture, trash);
    }
